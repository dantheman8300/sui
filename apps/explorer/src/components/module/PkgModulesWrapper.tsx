...
function PkgModuleViewWrapper({ id, modules }: Props) {
    ...
    return (
        <div className="flex flex-col md:flex-row md:flex-nowrap gap-5 border-0 border-y border-solid border-sui-grey-45">
            ...
            <div
                className={clsx(
                    'border-0 md:border-l border-solid border-sui-grey-45 md:pl-7 pt-5 grow overflow-auto',
            ...
            {isModuleFnExecEnabled ? (
                <div className="border-0 md:border-l border-solid border-sui-grey-45 md:pl-7 pt-5 grow overflow-auto md:w-3/5">
                    <TabGroup size="md">
                        <TabList>
                            <Tab>Execute</Tab>
                        </TabList>
